...
export default function Attractions(): JSX.Element {
  const { t } = useLocale();
  ...
  return (
    <section id="attractions" className="min-h-screen flex items-center justify-center bg-neutral-50 text-gray-800">
      <div className="max-w-5xl mx-auto px-6 w-full pt-20 pb-8">
        ...
        <div className="px-2 md:px-0">
          <Carousel
            ...
            renderItem={(wf: Waterfall) => (
              <div className="flex flex-col md:flex-row items-stretch gap-4 p-4 h-full box-border">
                ...
                <div className="flex-1 flex flex-col justify-center p-2 min-h-0">
                  ...
                  <div className="text-sm text-gray-600 mt-2">{wf.distance} {t('attractions.from_house') ?? 'da pousada'}</div>
                  <div className="text-sm text-gray-600">{wf.walking_time} {t('attractions.walk')}</div>
                </div>
              </div>
            )}
            interval={5000}
