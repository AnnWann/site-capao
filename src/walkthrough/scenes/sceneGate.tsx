...
function GateSceneView({ scene, goTo, back, canGoBack }: WalkthroughSceneComponentProps): JSX.Element {
  return (
...
export const buildGateScene = (): WalkthroughScene => ({
  id: 'gate',
  walkthrough: 'Walkthrough',
  place: 'Portão',
  description: 'Cena de exemplo. Cada cena decide como animar e para onde navegar.',
